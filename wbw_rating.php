...
function str_insert($insertstring, $intostring, $offset) 
{
 ...
 function get_template_icons()
 {
	 ...
	 $icons['uv'] = '[[Datei:Qsicon Unverstaendlich.svg|Unverständlich|verweis=Kategorie:Wikipedia:Unverständlich|15x15px]]';	 
	 ...
	 $icons['bw'] = '[[Datei:Photo-request.svg|Bilderwunsch|verweis=Kategorie:Wikipedia:Bilderwunsch|30x15px]]';
