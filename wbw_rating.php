...
function str_insert($insertstring, $intostring, $offset) 
{
 ...
 function get_template_icons()
 {
	 ...
	 $icons['uv'] = '[[Datei:Qsicon Unverstaendlich.svg|link=Kategorie:Wikipedia:Unverständlich|15x15px]]';	 
	 ...
	 $icons['dw'] = '[[Datei:Qsicon Weblink red.svg|link=Kategorie:Wikipedia:Defekte Weblinks|15px]]';
	 $icons['geo'] = '[[Datei:Gnome-globe.svg|Lagewunsch|verweis=Kategorie:Wikipedia:Lagewunsch|15px]]';
	 $icons['bw'] = '[[Datei:Photo-request.svg|Bilderwunsch|link=Kategorie:Wikipedia:Bilderwunsch|30x15px]]';
	 $icons['fwl'] = 'Wartungsliste';
	 $icons['v5'] = '[[Datei:Dodecahedron.svg|Vielseitigkeitsbonus|15x15px]]';
	 $icons['m50'] = '[[Datei:Noto Emoji Oreo 1f41e.svg|Mengenbonus|18x18px]]';
	return $icons;
 }	
